  ...
  faqList: [
    {
      ...
      answer: `While ${branding.brandName} is designed with SaaS applications in mind, it’s not limited to SaaS products. ${branding.brandName} is multipurpose and can be used for a variety of websites and applications, whether it’s for an agency, digital product, Plugin, blog, AI platform, or any other system. ${branding.brandName} is versatile and adaptable to fit any use case, SaaS or not. It’s built for all types of projects!`,
      category: 'General'
    },
    {
      question: `Is the plugin compatible with my website's theme?`,
    ...
    {
      question: `Can I customize the plugin's appearance?`,
      answer: {
    ...
    {
      question: `How often are updates released for the plugin?`,
      answer: {
        content: `We regularly release updates to improve functionality, fix bugs, and add new features. Updates are typically rolled out every few months.`,
        type: 'list',
        data: [{ primary: 'Fix bugs' }, { primary: 'Add new features' }, { primary: 'Updates are typically rolled out every few months.' }]
      },
      category: 'General'
    },
    {

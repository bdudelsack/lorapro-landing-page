...
// @types
import { ContactUsFormProps } from '@/types/contact-us';
...
export default function ContactUsForm2() {
  ...
  const {
    ...
    formState: { errors },
    setValue
  } = useForm<ContactUsFormProps>({ defaultValues: { dialcode: '+91' } });

  // Handle form submission
  const onSubmit: SubmitHandler<ContactUsFormProps> = (data) => {
    console.log(data);
    reset();
  };
